...
const Phim = ({ data }) => {
     ...
     return (
          <section className="section section--head section--head-fixed section--gradient section--details-bg">
                              ...
                              <div className="col-12 col-xl-8">
                                   ...
                                   <div className="article__content">
                                        ...
                                        <div className="article__btns">
                                             <a href={`/xem-phim/${movie.slug}?server=${encodeURIComponent(episodes.server_name)}&tap=${encodeURIComponent(episodes.server_data[0].slug)}`} className="article__btn">Xem ngay</a>
                                             <button onClick={showModal} className="article__btn article__btn--white">Xem trên điện thoại</button>
                                        </div>
               ...
               <Modal width={300} centered open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
                    <div className="qr_code_vd">
                         <QRCode type="canvas" value={url} />
                    </div>
                    <p className="qr_code_title">Quét mã QR để xem trên điện thoại</p>
               </Modal>
          </section>
