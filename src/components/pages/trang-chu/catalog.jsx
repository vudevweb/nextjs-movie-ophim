'use client'
export default function Catalog({ data , uImg}) {
     return (
          <div className="catalog">
               <div className="container">
                         ...
                         <div className="col-12">
                              <div className="catalog__nav">
                                   ...
                                   <div className="slider-radio">
                                        <input type="radio" name="grade" id="featured" defaultChecked="checked" /><label htmlFor="featured">Featured</label>
                                        ...
                                        <div key={index} className="col-6 col-sm-4 col-lg-3 col-xl-2">
                                             <div className="card">
                                                  <a href="details.html" className="card__cover">
                                                       <img src={`${uImg+item.thumb_url}`} alt="" height={290}/>
                                                  ...
                                                  <h3 className="card__title"><a href="details.html">{ item.name }</a></h3>
                    ...
                    <div className="row">
                         <div className="col-12">
                              <button className="catalog__more" type="button">Xem thêm</button>
                         </div>
                    </div>
               </div>
          </div>
