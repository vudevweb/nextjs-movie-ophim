...
export default function Slide({ data }) {
     ...
     console.log(data);
     return (
          <div className="home home--title" style={{ marginBottom: "100px" }}>
               <div className="container">
                    <div className="row">
                         <div className="col-12">
                              <h1 className="home__title"><b>PHIMMOI</b> HOT NHẤT NĂM 2024</h1>
                         </div>
                    </div>
               </div>
                    ...
                    {movie.map((item, index) => (
                         <div key={index} className="home__card">
                              <a href={`/phim/${item.slug}`} >
                                   <img src={`${uImg + item.poster_url}`} alt={item.name} />
                              </a>
                              <div>
                                   <h2>{item.name}</h2>
                                   <ul>
